...
public class walkActivityService extends Service implements
    ...
    public void onCreate() {
        ...
        walkActivity.getINSTANCE(getApplicationContext());
    }
    ...
    protected synchronized void buildGoogleApiClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .addConnectionCallbacks( walkActivityService.this)
                .addOnConnectionFailedListener( walkActivityService.this)
    ...
    void backgroundUpdate(){
        ...
        if (mCurrentLocation != null) {
            ...
            latValue = mCurrentLocation.getLatitude();
            longValue = mCurrentLocation.getLongitude();
            ...
            if (locationB == null) {
                ...
                locationB.setLatitude(0.0);
                locationB.setLongitude(0.0);


            } else {
                if (locationB.getLongitude() != 0.0) {
                    distance = locationB.distanceTo(locationA);

                    if(walkActivity.getmRequestingLocationUpdates()) { // if start button is clicked
                        total_distance += distance;
                        SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
                        editor.putFloat("distance_prefs", total_distance);
                        editor.commit();
                        //Toast.makeText(this, mCurrentLocation.getLatitude() + ", " + mCurrentLocation.getLatitude(), Toast.LENGTH_SHORT).show();
           ...
           // LocalBroadcastManager.getInstance(walkActivityService.this).sendBroadcast(new Intent(MainActivity.LOCAL_NOTIFICATION_STRING));
        }
    }
